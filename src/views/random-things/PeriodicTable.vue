...
<template>
  <main>
    ...
    <table>
      <tbody>
        ...
        <tr>
          ...
          <td
            @click="onElementClick"
            class="element alkali"
            data-name="lithium">
            <small>3</small> Li <small>Lithium</small>
          </td>
          <td
            @click="onElementClick"
            class="element alkaline"
            data-name="beryllium">
        ...
        <tr>
          ...
          <td
            @click="onElementClick"
            class="element transition-metal"
            data-name="molybdenum">
            <small>42</small> Mo <small>Molybdenum</small>
          </td>
          <td
            @click="onElementClick"
            class="element transition-metal"
            data-name="technetium">
        ...
        <tr>
          ...
          <template v-else>
            <td
              @click="onElementClick"
              class="element lanthanides-switch transition-metal"
              data-name="hafnium">
            ...
            <td
              @click="onElementClick"
              class="element lanthanides-switch post-transition-metal"
              data-name="thallium">
            ...
            <td
              @click="onElementClick"
              class="element lanthanides-switch metalloid"
              data-name="polonium">
              <small>84</small> Po <small>Polonium</small>
            </td>
            <td
              @click="onElementClick"
              class="element lanthanides-switch halogen"
              data-name="astatine">
              <small>85</small> At <small>Astatine</small>
            </td>
            <td
              @click="onElementClick"
              class="element lanthanides-switch noble-gas"
              data-name="radon">
        ...
        <tr>
          ...
          <template v-if="showActinides">
            ...
            <td
              @click="onElementClick"
              class="element actinide"
              data-name="californium">
              <small>98</small> Cf <small>Californium</small>
            </td>
            <td
              @click="onElementClick"
              class="element actinide"
              data-name="einsteinium">
          ...
          <template v-else>
            <td
              @click="onElementClick"
              class="element actinides-switch transition-metal"
              data-name="rutherfordium">
    ...
    <dialog
      ...
      open
      v-if="elementDetails"
      @click.self="elementDetails = null">
      <div class="modal-dialog">
        <div class="modal-head">
          <h2>{{ elementDetails.name }}</h2>

          <button type="button" @click="elementDetails = null">&times;</button>
        </div>
