...
const PERIODIC_TABLE_DATA = json as unknown as Record<string, PeriodicElement | string[]>;
...
<template>
  <main>
    ...
    <table>
      <tbody>
        ...
        <tr>
          ...
          <td id="lanthanides" tabindex="0" @click="() => { showLanthanides = !showLanthanides; showActinides = false; }" :class="{ active: showLanthanides }">
            <div>LANTHANIDES</div>
          </td>
        ...
        <tr>
          ...
          <td id="actinides" tabindex="0" @click="() => { showActinides = !showActinides; showLanthanides = false; }" :class="{ active: showActinides }">
            <div>ACTINIDES</div>
          </td>
    ...
    <dialog class="modal" open v-if="elementDetails" @click.self="elementDetails = null">
